...
var home = process.env.INSIGHT_DB || (getUserHome() + '/.insight-sugarchain');
...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\sugarchain\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/sugarchain/';
  if (isLinux) dataDir = process.env.HOME + '/.sugarchain/';
}
